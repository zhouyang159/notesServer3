...
import com.aboutdk.note.client.UserApplicationClient;
...
public class UserController {
   ...
   @Autowired
   private UserApplicationClient userApplicationClient;
   ...
   private ResponseVO loginFromWeixinMiniprogram(@RequestParam("code") String jsCode) throws Exception {
      ...
      String uri = "https://api.weixin.qq.com/sns/jscode2session?appid=" + APPID + "&secret=" + APPSECRET + "&js_code=" + jsCode + "&grant_type=authorization_code";
      ...
      if (find == null) {
         ...
         String responseVOStr = userApplicationClient.registerWithOpenid(openid);
